              ...
              <div key={order.id} className="order-container">
                ...
                <div className="order-details-grid">
                  {order.products.map((productDetail) => {
                    return (
                      <Fragment key={productDetail.productId}>
                        <div className="product-image-container">
                          <img src={productDetail.product.image} />
                        </div>

                        <div className="product-details">
                          <div className="product-name">{productDetail.product.name}</div>
                          <div className="product-delivery-date">
                            Arriving on: {formatDay(productDetail.estimatedDeliveryTimeMs)}
                          </div>
